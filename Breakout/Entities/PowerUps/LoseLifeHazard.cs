...
public class LoseLifeHazard : IPowerUpType
{
    ...
    public void DropPowerUp(BlockEntity block)
    {
        ...
        var powerUp = PowerUpEntity.Create(position, "LoseLife", new LoseLifeHZActivator(GameRunningState.GetInstance().EntityManager.PlayerEntity));
