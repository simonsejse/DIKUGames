...
public class SplitBallPowerUp : IPowerUpType
{
    public IBaseImage GetImage()
    {
        return new Image(Path.Combine("Assets", "Images", "SplitPowerUp.png"));
    }
    ...
    public void DropPowerUp(BlockEntity block)
    {
        ...
        var powerUp = PowerUpEntity.Create(position, "SplitPowerUp", new SplitBallPowerUpActivator(GameRunningState.GetInstance().EntityManager));
