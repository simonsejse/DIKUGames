...
public class WidePowerUp : IPowerUpType
{
    ...
    public void DropPowerUp(BlockEntity block)
    {
        ...
        var powerUp = PowerUpEntity.Create(position, "WidePowerUp", new WidePowerUpActivator(GameRunningState.GetInstance().EntityManager.PlayerEntity));
