...
public class GameModifierEntity : Entity {
    ...
    private GameModifierEntity(Shape shape, IBaseImage image, 
        IGameModifierActivator gameModifierActivator) : base(shape, image) {
    ...
    /// <returns></returns>
    public static GameModifierEntity Create(Vec2F pos, IBaseImage image, 
        IGameModifierActivator gameModifierActivator) {
